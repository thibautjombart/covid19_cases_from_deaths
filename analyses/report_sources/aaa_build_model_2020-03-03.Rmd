...
* **Onset-to-death distribution**: log-Normal with mean 20.2 days and standard
  deviation 11.6;

<!-- * **Onset-to-death distribution**: Gamma(4.726, 0.3151). Source: -->
...
corresponding to `lnorm(2.839078, 0.577242)`.
...
r_onset_death <- function(n = 1, min_delay =1, max_delay = 100) {
...
rio::export(simulate_cases, file = "rds_outputs/simulate_cases.rds")

## export to main rds folder
rio::export(simulate_cases, file = here("rds", "simulate_cases.rds"))
