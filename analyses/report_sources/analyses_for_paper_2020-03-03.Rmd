...
if(Sys.info()["sysname"] == "Windows"){
  sim_deaths <- function(death_dates){
    ...
    clusterExport(cl, list("death_dates"), envir = environment())
    clusterExport(cl, list("simulate_cases", "params"), envir = .GlobalEnv)
...
skr_death_dates <- extract_death_dates(df, "South Korea")

skr_first_death_date <- min(skr_death_dates)

sims_skr_cases <- sim_deaths(skr_first_death_date)

results_skr_cases <- get_summaries(sims_skr_cases, skr_first_death_date)
