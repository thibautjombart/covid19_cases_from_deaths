...
sims_jp_cases <- sim_deaths(jp_first_death_dates, params_jp, duration = 14)
...
## Define country specific parameters - based on report 95%CI with data as of 2020-03-02
## Rt estimates have declined since initial outbreak so these numbers will be conservative?
params_sk <- expand.grid(R = c(2, 3),
                      cfr = c(0.01, 0.02, 0.03))

sims_sk_cases <- sim_deaths(sk_first_death_dates, params_sk, duration = 14)
...
sims_ch_cases <- sim_deaths(ch_first_death_dates, params_ch, duration = 14)
