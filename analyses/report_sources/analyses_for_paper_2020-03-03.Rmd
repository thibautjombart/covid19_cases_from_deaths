...
if(Sys.info()["sysname"] == "Windows"){
  sim_deaths <- function(death_dates, params = NULL, model = "negbin", negbinsize = 0.16) {
    ...
    clusterExport(cl, list("death_dates", "params", "model", "negbinsize"), envir = environment())
...
sims_one_case <- sim_deaths(today, params, model = "negbin", negbinsize = 0.16)
